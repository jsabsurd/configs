...
alias dwmm="cd ~/.config/dwm && sudo make clean install"
alias dwmcon="sudo vim ~/.config/dwm/config.def.h"
alias lcht1="brightnessctl set 100%"
alias lcht5="brightnessctl set 50%"
alias lcht2="brightnessctl set 20%"
alias batpro="upower -i $(upower -e | grep 'BAT') | grep -E "percentage""
# alias batstat="upower -i $(upower -e | grep 'BAT') | grep -E "state|to\ full|percentage""
alias tun="cd /etc/openvpn && sudo openvpn --config /etc/openvpn/mullvad_de_all.conf"
...
path=('/home/johnny/.juliaup/bin' $path)
export PATH
